...
class __TwigTemplate_d8c80fef4ccf3b9fe95df86bf9f4c349df4ce4b2ce84d63eaa2e9703e1319c33 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_form_row($context, array $blocks = [])
    {
        ...
        if ((array_key_exists("expanded", $context) && ($context["expanded"] ?? null))) {
            ...
            // line 31
            echo "<div";
            $__internal_compile_0 = ["attr" => twig_array_merge(($context["row_attr"] ?? null), ["class" => twig_trim_filter(((((twig_get_attribute($this->env, $this->source, ($context["row_attr"] ?? null), "class", [], "any", true, true, false, 31)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, ($context["row_attr"] ?? null), "class", [], "any", false, false, false, 31), "")) : ("")) . " form-group row") . (((( !($context["compound"] ?? null) || ((array_key_exists("force_error", $context)) ? (_twig_default_filter(($context["force_error"] ?? null), false)) : (false))) &&  !($context["valid"] ?? null))) ? (" is-invalid") : (""))))])];
    ...
    public function block_fieldset_form_row($context, array $blocks = [])
    {
        ...
        // line 46
        echo "<fieldset";
        $__internal_compile_1 = ["attr" => twig_array_merge(($context["row_attr"] ?? null), ["class" => twig_trim_filter((((twig_get_attribute($this->env, $this->source, ($context["row_attr"] ?? null), "class", [], "any", true, true, false, 46)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, ($context["row_attr"] ?? null), "class", [], "any", false, false, false, 46), "")) : ("")) . " form-group"))])];
...
";
    ...
    public function block_submit_row($context, array $blocks = [])
    {
        ...
        // line 58
        echo "<div";
        $__internal_compile_2 = ["attr" => twig_array_merge(($context["row_attr"] ?? null), ["class" => twig_trim_filter((((twig_get_attribute($this->env, $this->source, ($context["row_attr"] ?? null), "class", [], "any", true, true, false, 58)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, ($context["row_attr"] ?? null), "class", [], "any", false, false, false, 58), "")) : ("")) . " form-group row"))])];
    ...
    public function block_reset_row($context, array $blocks = [])
    {
        ...
        // line 67
        echo "<div";
        $__internal_compile_3 = ["attr" => twig_array_merge(($context["row_attr"] ?? null), ["class" => twig_trim_filter((((twig_get_attribute($this->env, $this->source, ($context["row_attr"] ?? null), "class", [], "any", true, true, false, 67)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, ($context["row_attr"] ?? null), "class", [], "any", false, false, false, 67), "")) : ("")) . " form-group row"))])];
    ...
    public function block_checkbox_row($context, array $blocks = [])
    {
        ...
        // line 80
        echo "<div";
        $__internal_compile_4 = ["attr" => twig_array_merge(($context["row_attr"] ?? null), ["class" => twig_trim_filter((((twig_get_attribute($this->env, $this->source, ($context["row_attr"] ?? null), "class", [], "any", true, true, false, 80)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, ($context["row_attr"] ?? null), "class", [], "any", false, false, false, 80), "")) : ("")) . " form-group row"))])];
    ...
    {
        return new Source("", "bootstrap_4_horizontal_layout.html.twig", "/var/www/html/ec-cube/vendor/symfony/twig-bridge/Resources/views/Form/bootstrap_4_horizontal_layout.html.twig");
    }
}
