...
/* @admin/index.twig */
class __TwigTemplate_f46e5ecf1340759051d0e85e92defe141c496e2cd9390455eef635e4c8e91ee1 extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["OrderStatus"]) {
            ...
            // line 141
            ((( !twig_test_empty(($context["Orders"] ?? null)) && twig_get_attribute($this->env, $this->source, ($context["Orders"] ?? null), twig_get_attribute($this->env, $this->source, $context["OrderStatus"], "id", [], "any", false, false, false, 141), [], "array", true, true, false, 141))) ? (print (twig_escape_filter($this->env, (($__internal_compile_0 = ($context["Orders"] ?? null)) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0[twig_get_attribute($this->env, $this->source, $context["OrderStatus"], "id", [], "any", false, false, false, 141)] ?? null) : null), "html", null, true))) : (print (0)));
            echo "</span>
                                                </div>
                                            </div>
                                        </a>
...
";
    ...
    {
        return new Source("", "@admin/index.twig", "/var/www/html/ec-cube/src/Eccube/Resource/template/admin/index.twig");
    }
}
