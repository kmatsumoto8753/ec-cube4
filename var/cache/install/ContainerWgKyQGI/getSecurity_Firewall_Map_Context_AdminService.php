...
$c = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $b, new \Eccube\Security\Http\Authentication\EccubeLogoutSuccessHandler($b, ($this->privates['Eccube\\Request\\Context'] ?? $this->load('getContextService.php')), 'admin_login'), ['csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'admin_logout']);
